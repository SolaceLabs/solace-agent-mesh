        ...
        return (
            <div className="flex flex-col" style={{ minWidth: "200px" }}>
                ...
                <div
                    ...
                    style={{ marginTop: `-${HEADER_HEIGHT / 2}px`, paddingTop: `${HEADER_HEIGHT / 2 + (hasConditionRow ? 48 : 16)}px` }}
                >
                        ...
                        <div className="flex flex-col items-center gap-2">
                            {node.children.map((child, index) => (
                                <Fragment key={child.id}>
                                    {/* Iteration label */}
                                    <div className="mb-1 text-[10px] font-medium text-gray-500 dark:text-gray-400">Iteration {index + 1}</div>
                                    {renderChild(child)}
