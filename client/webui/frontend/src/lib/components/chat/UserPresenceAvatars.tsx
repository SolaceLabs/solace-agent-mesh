            ...
            {hasOverflow && (
                <Tooltip>
                    <TooltipTrigger asChild>
                        <div className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-(--secondary-w10) text-xs font-semibold text-(--secondary-text-wMain) ring-2 ring-(--background-w10)" style={{ marginLeft: "-8px" }}>
