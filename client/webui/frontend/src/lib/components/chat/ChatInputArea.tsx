    ...
    return (
        ...
        >
            ...
            <MentionContentEditable
                ...
                placeholder={isRecording ? "Recording..." : mentionsEnabled ? "How can MeshFlow help you today? (Type '/' to insert a prompt, '@' to mention someone)" : "How can I help you today? (Type '/' to insert a prompt)"}
