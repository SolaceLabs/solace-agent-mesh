...
export const ChatInputArea: React.FC<{ agents: AgentCardInfo[]; scrollToBottom?: () => void; compact?: boolean }> = ({ agents = [], scrollToBottom, compact = false }) => {
    ...
    if (isRecording) {
        ...
        inputPlaceholder = "Ask me about what I can do or how to get started";
    ...
    return (
        <div
            className={`rounded-lg border bg-(--background-w10) shadow-sm ${compact ? "p-2" : "p-4"} ${isDragging ? "border-dotted border-(--primary-wMain) bg-(--background-w20)" : ""}`}
