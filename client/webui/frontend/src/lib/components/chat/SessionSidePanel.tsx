...
import { SessionTagProvider } from "@/lib/providers/SessionTagProvider";
        ...
        <SessionTagProvider>
            <div className="bg-background flex h-full w-100 flex-col border-r">
                ...
                <div className="px-4 pt-3">
                    <BookmarkNav selectedTags={selectedTags} onTagsChange={setSelectedTags} />
                </div>

                {/* Chat Sessions */}
                <div className="mt-1 min-h-0 flex-1">
                    <ChatSessions selectedTags={selectedTags} />
                </div>
            </div>
        </SessionTagProvider>
    );
