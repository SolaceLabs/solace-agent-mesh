...
export function Toast({ id, message, type }: Notification) {
    return (
        <div id={id} className="transform transition-all duration-200 ease-in-out">
            <Alert className="light:border-none max-w-80 min-w-58 rounded-sm bg-(--darkSurface-bg) px-4 py-0 text-(--darkSurface-text) shadow-[0_4px_6px_-1px_rgba(0,0,0,0.15)]">
