...
export const NODE_BASE_STYLES = {
     ...
     */
    RECTANGULAR: "group relative flex cursor-pointer items-center justify-between rounded border border-transparent bg-[var(--color-background-w10)] px-4 py-3 shadow transition-all duration-200 ease-in-out hover:shadow-md dark:border-[var(--color-secondary-w80)] dark:bg-[var(--color-background-wMain)] dark:hover:bg-[var(--color-secondary-w80)] dark:!shadow-none",
    /** Rectangular compact style - used by Loop/Map collapsed nodes */
    RECTANGULAR_COMPACT: "group relative flex cursor-pointer items-center justify-between rounded border border-transparent bg-[var(--color-background-w10)] px-3 py-2 shadow transition-all duration-200 hover:shadow-md dark:border-[var(--color-secondary-w80)] dark:bg-[var(--color-background-wMain)] dark:hover:bg-[var(--color-secondary-w80)] dark:!shadow-none",
    ...
    CONTAINER_HEADER: "group relative mx-auto w-fit cursor-pointer rounded border border-transparent bg-[var(--color-background-w10)] shadow transition-all duration-200 hover:shadow-md dark:border-[var(--color-secondary-w80)] dark:bg-[var(--color-background-wMain)] dark:hover:bg-[var(--color-secondary-w80)] dark:!shadow-none",
    /** Condition pill style - used by Switch condition pills */
    CONDITION_PILL: "flex cursor-pointer items-center gap-1.5 rounded-md px-2 py-1 text-xs font-medium shadow-sm transition-all duration-200 bg-[var(--color-background-w10)] dark:border-[var(--color-secondary-w80)] dark:bg-[var(--color-background-wMain)] dark:hover:bg-[var(--color-secondary-w80)] dark:!shadow-none",
    /** Switch node style - similar to rectangular but without justify-between */
    SWITCH: "group relative cursor-pointer rounded border border-transparent bg-[var(--color-background-w10)] shadow transition-all duration-200 hover:shadow-md dark:border-[var(--color-secondary-w80)] dark:bg-[var(--color-background-wMain)] dark:hover:bg-[var(--color-secondary-w80)] dark:!shadow-none",
} as const;
