...
export default function SwitchFlowNode({ data, selected }: NodeProps<Node<WorkflowFlowNodeData>>) {
    ...
    return (
        <>
            ...
            <SwitchNode node={data.layoutNode} isSelected={selected} isHighlighted={isHighlighted} />
