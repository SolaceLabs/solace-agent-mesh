        ...
        try {
            ...
            return (
                <div className="relative h-full">
                    ...
                    <pre className="bg-card-background h-full overflow-auto rounded-lg p-3 font-mono text-sm dark:border">{yamlStr}</pre>
                </div>
            );
        } catch {
            ...
            <div className="flex-1 overflow-auto">
                {showCodeView ? (
                    ...
                    <div className="p-4">
                        ...
                        {/* Open Agent button (for agent nodes) - should only be available for enterprise user agents }
