...
const HEADER_ICON = (
    <div className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-full">
        <svg id="header-icon" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 500 150" width="100%" height="100%">
            ...
            />
            <path className="fill-(--nav-accent)" d="M464.7,123.7c0-6.5,5.3-11.8,11.8-11.8s11.8,5.3,11.8,11.8-5.3,11.8-11.8,11.8-11.8-5.3-11.8-11.8" />
        </svg>
    </div>
);
