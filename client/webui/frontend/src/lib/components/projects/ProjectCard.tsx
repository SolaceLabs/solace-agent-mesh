...
import { FileText, FolderOpen, MoreHorizontal, Download, Trash2, Share2, UserRound, UserCog } from "lucide-react";
                        ...
                        {isSharingEnabled && (
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <span className="cursor-default">{isOwner ? <UserCog className="h-4 w-4" /> : <UserRound className="h-4 w-4" />}</span>
                                </TooltipTrigger>
