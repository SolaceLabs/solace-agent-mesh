...
export const SolaceIcon: React.FC<SolaceIconProps> = ({ className }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 500 150" width="100%" height="100%" className={className}>
            <path
