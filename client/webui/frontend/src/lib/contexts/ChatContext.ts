...
export interface ChatActions {
    ...
    handleSubmit: (event: FormEvent | null, files?: File[] | null, message?: string | null, overrideSessionId?: string | null, displayHtml?: string | null, contextQuote?: string | null, contextQuoteSourceId?: string | null) => Promise<void>;
    handleCancel: () => void;
