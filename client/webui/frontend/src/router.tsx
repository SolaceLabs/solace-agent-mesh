...
import { AgentMeshPage, ChatPage, NavigationBlockerTestPage, ProjectsPage, PromptsPage } from "./lib";
    ...
    return createHashRouter([
        {
            ...
            children: [
                ...
                {
                    path: "test-navigation-blocker",
                    element: <NavigationBlockerTestPage />,
                },
                {
                    path: "*",
                    element: <Navigate to="/chat" replace />,
