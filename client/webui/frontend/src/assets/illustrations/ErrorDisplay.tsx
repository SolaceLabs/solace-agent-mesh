...
function ErrorDisplay({ width = 24, height = 24 }: ErrorDisplayProps) {
    return (
        <svg width={width} height={height} focusable="false" aria-hidden="true" viewBox="0 0 131 131" fill="none">
            ...
            <path d="M2.68115 119.495H128.681V120.495H2.68115V119.495Z" fill="#86939E" />
            <rect x={14} y={34} width={104.054} height={70.6982} rx={1} fill="#FFFFFF" stroke="#86939E" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
            <path
            ...
            <path
                ...
                strokeLinejoin="round"
            />
            <path d="M15.1406 95.0068H117.773" stroke="#86939E" strokeWidth={2} />
            <g clipPath="url(#clip0_1688:196070)">
                <rect opacity={0.2} x={54.1126} y={45.1681} width={24.1} height={24.1} stroke="#86939E" strokeWidth={0.1} />
                <path
            ...
            <defs>
                <clipPath id="clip0_1688:196070">
                    <rect width={24} height={24} fill="#FFFFFF" transform="translate(54.1626 45.2181)" />
                </clipPath>
            </defs>
        </svg>
    );
