...
export default function ErrorIllustration({ width = 24, height = 24 }: ErrorIllustrationProps) {
    return (
        <svg width={width} height={height} focusable="false" aria-hidden="true" viewBox="0 0 131 131" fill="none">
            ...
            />
            <path d="M2.68115 119.495H128.681V120.495H2.68115V119.495Z" fill="var(--color-border)" />
            <rect x={14} y={34} width={104.054} height={70.6982} rx={1} fill="var(--color-background-w10)" stroke="var(--color-border)" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
            <path
            ...
            <path
                ...
                strokeLinejoin="round"
            />
            <path d="M15.1406 95.0068H117.773" stroke="var(--color-border)" strokeWidth={2} />
            <g clipPath="url(#clip0_1688:196070)">
                <rect opacity={0.2} x={54.1126} y={45.1681} width={24.1} height={24.1} stroke="var(--color-border)" strokeWidth={0.1} />
                <path
