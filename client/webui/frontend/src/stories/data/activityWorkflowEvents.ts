...
function makeRequestEvent(text: string, timestamp = BASE_TIME, taskId = "task-1"): A2AEventSSEPayload {
    return makeEvent({
        direction: "request",
        timestamp,
        task_id: taskId,
...
function makeCompletedResponseEvent(text: string, agent = "OrchestratorAgent", timestamp: string, taskId = "task-1"): A2AEventSSEPayload {
    return makeEvent({
        direction: "response",
        timestamp,
        task_id: taskId,
...
function makeFailedResponseEvent(errorMessage: string, agent = "OrchestratorAgent", timestamp: string, taskId = "task-1"): A2AEventSSEPayload {
    return makeEvent({
        direction: "response",
        timestamp,
        task_id: taskId,
...
function makeStatusUpdateEvent(text: string, agent = "OrchestratorAgent", timestamp: string, taskId = "task-1"): A2AEventSSEPayload {
    return makeEvent({
        direction: "status-update",
        timestamp,
        task_id: taskId,
