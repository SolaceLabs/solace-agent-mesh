...
Example usage:
    from agent_tools import Artifact, ToolResult
...
class Artifact:
    ...
    def to_serializable(self) -> Dict[str, Any]:
        ...
        This is used when transmitting artifacts to Lambda functions.
        """
    ...
    @classmethod
    def from_serialized(cls, data: Dict[str, Any]) -> "Artifact":
        """
        Create an Artifact from a serialized dictionary.

        Handles base64-decoding of binary content.
        This is used when receiving artifacts in Lambda functions.
        """
