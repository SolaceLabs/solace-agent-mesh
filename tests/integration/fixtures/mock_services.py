...
def mock_oauth_server():
    ...
    class MockOAuthServer:
        def __init__(self):
            ...
            print(f"[MockOAuthServer] Pass-through configured for agent card path")
        ...
        def assert_token_requested(self, token_url: str, times: int = 1):
            ...
            assert route.call_count == times, f"Expected {times} calls to {token_url}, got {route.call_count}"
                    ...
                    MockCandidate(
                        content=MockContent(
                            parts=[
                                ...
                                MockPart(
                                    inline_data=type("obj", (object,), {"data": edited_image_bytes})()
                                ),
                            ]
                        )
                    )
