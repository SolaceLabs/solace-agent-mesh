...
class SimpleDatabaseInspector:
    ...
    def get_agent_sessions(self, agent_name: str, gateway_session_id: Optional[str] = None) -> List[AgentSessionRecord]:
    ...
    def get_agent_messages(self, agent_name: str, gateway_session_id: str) -> List[MessageRecord]:
