...
class GatewayAdapter:
    ...
    def seed_session_for_project(
        ...
        """Seed a session associated with a project in the database for testing.
        ...
        Args:
            ...
            agent_id: The agent ID for the session
        ...
        return created_session._asdict() if created_session else None
