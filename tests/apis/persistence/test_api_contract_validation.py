...
class TestHTTPStatusCodes:
    ...
    def test_unauthorized_access_returns_404(self, api_client: TestClient):
        ...
        response = api_client.patch("/api/v1/sessions/nonexistent", json={"name": "Test"})
        assert response.status_code == 404
