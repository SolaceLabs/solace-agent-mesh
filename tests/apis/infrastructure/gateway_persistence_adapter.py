...
class GatewayPersistenceAdapter:
    ...
    def __init__(self, test_gateway_component: TestGatewayComponent, db_manager: MultiDatabaseManager):
    ...
    async def send_message(self, session_id: str, message: str, user_id: Optional[str] = None) -> MessageResponse:
    ...
    async def delete_session(self, session_id: str) -> bool:
        ...
        await gateway_conn.execute(
            "DELETE FROM gateway_messages WHERE session_id = ?",
            (session_id,)
        )
