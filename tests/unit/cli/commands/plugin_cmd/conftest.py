...
def mock_get_module_path(mocker):
    ...
    return mocker.patch(
        "cli.commands.plugin_cmd.install_cmd.get_module_path",
        side_effect=_get_module_path,
    )
...
def mock_official_registry(mocker):
    ...
    mocker.patch(
        "cli.commands.plugin_cmd.install_cmd.get_official_plugin_url", return_value=None
    )
    mocker.patch(
        "cli.commands.plugin_cmd.create_cmd.is_official_plugin", return_value=False
    )
    return mocker
