...
class TestApplyJsonPath:
    ...
    def test_jsonpath_simple_query(self):
        ...
        result, mime, error = _apply_jsonpath(data, "$.name", "application/json", "[Test]")
    ...
    def test_jsonpath_invalid_input_type(self):
        ...
        result, mime, error = _apply_jsonpath("not a dict", "$.name", "application/json", "[Test]")
    ...
    def test_jsonpath_invalid_expression(self):
        ...
        data = {"name": "Alice"}
        result, mime, error = _apply_jsonpath(data, "$[invalid", "application/json", "[Test]")
...
class TestApplySelectCols:
    ...
    def test_select_multiple_columns(self):
        ...
        result, mime, error = _apply_select_cols(data, "name, age", "text/csv", "[Test]")
    ...
    def test_select_cols_invalid_column(self):
        ...
        data = [{"name": "Alice"}]
        result, mime, error = _apply_select_cols(data, "invalid_col", "text/csv", "[Test]")
    ...
    def test_select_cols_invalid_input_type(self):
        ...
        result, mime, error = _apply_select_cols("not a list", "name", "text/csv", "[Test]")
...
class TestApplyFilterRowsEq:
    ...
    def test_filter_rows_basic(self):
        ...
        result, mime, error = _apply_filter_rows_eq(data, "name:Alice", "text/csv", "[Test]")
    ...
    def test_filter_rows_numeric_value(self):
        ...
        result, mime, error = _apply_filter_rows_eq(data, "age:30", "text/csv", "[Test]")
    ...
    def test_filter_rows_no_matches(self):
        ...
        data = [{"name": "Alice"}, {"name": "Bob"}]
        result, mime, error = _apply_filter_rows_eq(data, "name:Charlie", "text/csv", "[Test]")
    ...
    def test_filter_rows_invalid_format(self):
        ...
        data = [{"name": "Alice"}]
        result, mime, error = _apply_filter_rows_eq(data, "invalid_format", "text/csv", "[Test]")
    ...
    def test_filter_rows_empty_data(self):
        ...
        result, mime, error = _apply_filter_rows_eq([], "name:Alice", "text/csv", "[Test]")
...
class TestApplySliceRows:
    ...
    def test_slice_rows_invalid_input_type(self):
        ...
        result, mime, error = _apply_slice_rows("not a list", "0:5", "text/csv", "[Test]")
...
class TestApplySelectFields:
    ...
    def test_select_fields_basic(self):
        ...
        result, mime, error = _apply_select_fields(data, "name, age", "application/json", "[Test]")
    ...
    def test_select_fields_single_field(self):
        ...
        data = [{"name": "Alice", "age": 30}]
        result, mime, error = _apply_select_fields(data, "name", "application/json", "[Test]")
    ...
    def test_select_fields_no_fields(self):
        ...
        data = [{"name": "Alice"}]
        result, mime, error = _apply_select_fields(data, "", "application/json", "[Test]")
    ...
    def test_select_fields_invalid_input_type(self):
        ...
        result, mime, error = _apply_select_fields("not a list", "name", "application/json", "[Test]")
...
class TestApplyTemplate:
    ...
    async def test_template_with_dict_context(self):
        ...
        with patch('solace_agent_mesh.common.utils.embeds.modifiers.resolve_embeds_recursively_in_string') as mock_resolve:
    ...
    @pytest.mark.asyncio
    async def test_template_pystache_not_available(self):
        """Test template when pystache is not available."""
        with patch('solace_agent_mesh.common.utils.embeds.modifiers.PYSTACHE_AVAILABLE', False):
            result, mime, error = await _apply_template(
                {}, "template.txt", "text/plain", "[Test]", {}
            )
            
            assert error is not None
            assert "pystache" in error
...
class TestParseModifierChain:
    ...
    def test_parse_with_single_modifier(self):
        ...
        artifact_spec, modifiers, output_format = _parse_modifier_chain("data.csv|head:10")
...
class TestEdgeCases:
    ...
    def test_filter_rows_with_colon_in_value(self):
        ...
        result, mime, error = _apply_filter_rows_eq(data, "url:http://example.com", "text/csv", "[Test]")
