...
DEFAULT_MAX_LLM_CALLS_PER_TASK = 20
...
TEXT_ARTIFACT_CONTEXT_MAX_LENGTH_CAPACITY = (
    200000  # maximum number of characters that can be loaded from a text artifact
)
TEXT_ARTIFACT_CONTEXT_DEFAULT_LENGTH = (
    100000  # default number of characters to load from a text artifact
)
