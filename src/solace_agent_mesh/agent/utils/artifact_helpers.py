...
async def delete_artifact_with_metadata(
    ...
    try:
        ...
        try:
            ...
            log.warning("%s Artifact '%s' not found for deletion: %s", log_identifier, filename, e)
            status = "error"
        ...
        try:
            ...
            log.warning("%s Metadata artifact '%s' not found for deletion: %s", log_identifier, metadata_filename, e)
