...
class SessionService:
    ...
    def get_user_sessions(
        ...
        Args:
            ...
            app_id: Optional app ID to filter sessions by (for app-specific views)
        """
        ...
        # Fetch sessions with optional project/app filtering
        sessions = session_repository.find_by_user(db, user_id, pagination, project_id=project_id, app_id=app_id)
        total_count = session_repository.count_by_user(db, user_id, project_id=project_id, app_id=app_id)
