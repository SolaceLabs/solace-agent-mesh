...
class DataRetentionService:
    ...
    SSE event buffer based on configurable retention policies,
    ...
    def __init__(
        ...
        log.info(
            ...
            "sse_event_retention=%d days, conversion_cache_retention=%d hours, cleanup_interval=%d hours, batch_size=%d",
            self.log_identifier,
