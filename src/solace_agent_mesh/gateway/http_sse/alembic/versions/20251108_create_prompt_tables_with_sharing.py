...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('production_prompt_id', sa.String(255), nullable=True),
    ...
    op.create_table(
        'prompt_group_users',
        sa.Column('id', sa.String(255), nullable=False),
        sa.Column('prompt_group_id', sa.String(255), nullable=False),
        sa.Column('user_id', sa.String(255), nullable=False),
        sa.Column('role', sa.String(255), nullable=False, server_default='viewer'),
