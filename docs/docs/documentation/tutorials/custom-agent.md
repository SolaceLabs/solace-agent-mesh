...
- Read the [Create Agent](../developing/create-agents.md) tutorial
...
For an example of plugin agents, see the [Create Agents](../developing/create-agents.md#creating-your-first-agent-step-by-step) guide.
:::
...
This tutorial uses the `sam add agent` command to create a new agent named "Weather Agent", for an example of creating a custom agent plugin, see the [Create Agents](../developing/create-agents.md) tutorial.
