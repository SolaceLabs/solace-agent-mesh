...
- **LLM API key** (optional at install time)—you can configure your LLM models later through the Agent Mesh UI after starting the application. For details, see [Model Configurations](./model_configurations.md)
