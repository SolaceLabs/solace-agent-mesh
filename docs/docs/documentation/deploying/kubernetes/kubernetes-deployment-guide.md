...
* **Configuration:** Refer to the [_Session Storage_](../../installing-and-configuring/session-storage.md) _and_ [_Artifact Storage_](../../installing-and-configuring/artifact-storage.md) to configure connection strings and secrets for your installation.
