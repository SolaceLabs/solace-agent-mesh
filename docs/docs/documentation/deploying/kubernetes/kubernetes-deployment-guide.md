...
* **Configuration:** Refer to the [_Session Storage_](/docs/documentation/installing-and-configuring/session-storage.md) _and_ [_Artifact Storage_](/docs/documentation/installing-and-configuring/artifact-storage.md) to configure connection strings and secrets for your installation.
